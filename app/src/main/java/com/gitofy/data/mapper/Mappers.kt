...
fun Repository.toDomain(): RepoSummary = RepoSummary(
    ...
    ownerAvatar = owner?.avatarUrl?.takeIf { it.isNotBlank() }
...
fun Branch.toEntity(repoId: Long, ownerLogin: String = "", repoName: String = ""): BranchEntity = BranchEntity(
    name = name,
    repoId = repoId,
    ownerLogin = ownerLogin,
    repoName = repoName,
...
fun Commit.toEntity(repoId: Long, ownerLogin: String = "", repoName: String = ""): CommitEntity = CommitEntity(
    sha = sha,
    repoId = repoId,
    ownerLogin = ownerLogin,
    repoName = repoName,
...
fun Workflow.toEntity(repoId: Long, ownerLogin: String = "", repoName: String = ""): WorkflowEntity = WorkflowEntity(
    id = id,
    repoId = repoId,
    ownerLogin = ownerLogin,
    repoName = repoName,
...
fun WorkflowRun.toEntity(repoId: Long, ownerLogin: String = "", repoName: String = ""): WorkflowRunEntity = WorkflowRunEntity(
    id = id,
    repoId = repoId,
    ownerLogin = ownerLogin,
    repoName = repoName,
