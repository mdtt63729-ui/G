...
class JGitEngine @Inject constructor() : GitRepository {
    ...
    override suspend fun initialize(directory: String): Result<Unit> {
        return try {
            ...
            GITOFYLogger.e("Git init failed", e)
            Result.failure(GitOFYError.GitError("Initialization failed: ${e.message}"))
        }
    }
    ...
    override suspend fun configureUser(directory: String, name: String, email: String): Result<Unit> {
        return try {
            ...
            GITOFYLogger.e("Git config failed", e)
            Result.failure(GitOFYError.GitError("Config failed: ${e.message}"))
        }
    }
    ...
    override suspend fun addAll(directory: String): Result<Unit> {
        return try {
            ...
            GITOFYLogger.e("Git add failed", e)
            Result.failure(GitOFYError.GitError("Staging failed: ${e.message}"))
        }
    }
    ...
    override suspend fun commit(directory: String, message: String): Result<Unit> {
        return try {
            ...
            GITOFYLogger.e("Git commit failed", e)
            Result.failure(GitOFYError.GitError("Commit failed: ${e.message}"))
        }
    }
    ...
    override suspend fun setRemote(directory: String, remoteUrl: String): Result<Unit> {
        return try {
            ...
            GITOFYLogger.e("Git setRemote failed", e)
            Result.failure(GitOFYError.GitError("Remote setup failed: ${e.message}"))
        }
    }
    ...
    override suspend fun push(directory: String, token: String, remoteUrl: String): Result<Unit> {
        return try {
            ...
            GITOFYLogger.e("Git push failed", e)
            Result.failure(GitOFYError.GitError("Push failed: ${e.message}"))
        }
    }
    ...
    override suspend fun verifyRemote(directory: String, remoteUrl: String): Result<Unit> {
        return try {
            ...
            Result.failure(GitOFYError.GitError("Verification failed: ${e.message}"))
        }
    }
