...
class ModelRegistry @Inject constructor() {
    ...
    init {
        ...
        register(ModelRecord("gemini-2.0-flash", "gemini", "Gemini 2.0 Flash", 1_000_000,
            ...
            codingScore = 8, reasoningScore = 8, latencyClass = LatencyClass.FAST, costClass = CostClass.FREE,
        ...
        register(ModelRecord("gemini-2.5-pro", "gemini", "Gemini 2.5 Pro", 2_000_000,
            ...
            visionSupport = true, toolCalling = true, structuredOutput = true, streaming = true,
            codingScore = 9, reasoningScore = 10, latencyClass = LatencyClass.MEDIUM, costClass = CostClass.LOW_COST,
            availability = Availability.AVAILABLE, fallbackPriority = 2))

        register(ModelRecord("nim-llama-3.1-70b", "nvidia_nim", "Llama 3.1 70B (NIM)", 128_000,
            ...
            codingScore = 8, reasoningScore = 9, latencyClass = LatencyClass.MEDIUM, costClass = CostClass.FREE,
            availability = Availability.AVAILABLE, fallbackPriority = 3))

        register(ModelRecord("nim-deepseek-coder-33b", "nvidia_nim", "DeepSeek Coder 33B (NIM)", 128_000,
            ...
            codingScore = 9, reasoningScore = 7, latencyClass = LatencyClass.FAST, costClass = CostClass.FREE,
            availability = Availability.AVAILABLE, fallbackPriority = 4))

        register(ModelRecord("openrouter-auto", "openrouter", "OpenRouter Auto", 128_000,
            setOf(InputCapability.TEXT, InputCapability.CODE), setOf(OutputCapability.TEXT, OutputCapability.CODE),
            visionSupport = false, toolCalling = true, structuredOutput = true, streaming = true,
            codingScore = 7, reasoningScore = 7, latencyClass = LatencyClass.FAST, costClass = CostClass.LOW_COST,
            availability = Availability.AVAILABLE, fallbackPriority = 5))

        register(ModelRecord("opencode-zen-default", "opencode_zen", "OpenCode Zen", 64_000,
            setOf(InputCapability.TEXT, InputCapability.CODE), setOf(OutputCapability.TEXT, OutputCapability.CODE, OutputCapability.PATCH),
            visionSupport = false, toolCalling = false, structuredOutput = false, streaming = true,
            codingScore = 7, reasoningScore = 6, latencyClass = LatencyClass.MEDIUM, costClass = CostClass.FREE,
