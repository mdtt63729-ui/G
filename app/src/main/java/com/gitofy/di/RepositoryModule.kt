...
import com.gitofy.ai.credentials.EncryptedCredentialRepository
...
abstract class RepositoryModule {
    ...
    @Binds @Singleton
    abstract fun bindGitRepository(impl: GitNativeManager): GitRepository

    @Binds @Singleton
    abstract fun bindAiCredentialStore(impl: EncryptedCredentialRepository): AiCredentialStore
}
